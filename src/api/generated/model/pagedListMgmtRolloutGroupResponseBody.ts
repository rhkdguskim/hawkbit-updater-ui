 ...
 */
import type { MgmtRolloutGroupResponseBody } from './mgmtRolloutGroupResponseBody';
import type { Links } from './links';

export interface PagedListMgmtRolloutGroupResponseBody {
  content: MgmtRolloutGroupResponseBody[];
  total?: number;
  size?: number;
  _links?: Links;
}
