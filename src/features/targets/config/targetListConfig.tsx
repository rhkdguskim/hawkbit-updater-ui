...
import { TargetTagsCell } from '../components/TargetTagsCell';
import { TargetTypeCell } from '../components/TargetTypeCell';
import { InstalledModulesCell } from '../components/InstalledModulesCell';
import { StatusIndicator } from '../components/StatusIndicator';
import { Highlighter } from '@/components/common/Highlighter';

const { Text } = Typography;

import { COLUMN_CONFIG, ALLOWED_SORT_FIELDS, type ColumnConfig } from '../types/columnConfig';
...
export { FILTER_FIELD_CONFIG, type FilterFieldConfig } from '../types/columnConfig';
